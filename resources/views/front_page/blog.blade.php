    ...
    <div class="container">
        <div class="page-header-wrapper">
            <div class="page-header-content">
                <h2 class="title"><span class="text-generic-green">Blog</span>List</h2>
                        ...
                        <div class="post-item style-two">
                            ...
                            <div class="post-content">
                                <div class="post-header">
                                    <h4 class="title">
                                        <a href="{{ url('blog/'.Str::slug(ucwords($post->title))) }}">{{ $post->title }}</a>

                                        @if (Auth::check() && Auth::user()->is_admin)
                                                <a href="/backoffice/post/update/{{ $post->id }}" style="font-size: 12px"><span class="badge badge-success"><i class="fa fa-pencil-alt"></i> edit</span></a>
                                        @endif
                                    </h4>
                                    <p>{{ $post->short_desc }}</p>
                                </div>
                ...
                <aside class="sidebar">
                    ...
                    <div class="widget widget-tags">
                        ...
                        <div class="tag-item-wrapper">
                            @foreach ($tags as $tag)
                                <a href="/search/?tag={{urlencode($tag->title)}}" class="tag-item">{{ $tag->title }}</a>
                            @endforeach
                        </div>
                    </div>
